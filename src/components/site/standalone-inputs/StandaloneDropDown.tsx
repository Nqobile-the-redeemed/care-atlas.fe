    ...
    <div ref={dropdownRef} className={`relative flex w-full flex-col gap-2 ${className || ''}`}>
      ...
      >
        ...
        <button
          ...
          disabled={disabled}
          className='focus:ring-blue-duskBlue/20 ml-2 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-gray-600 transition hover:bg-gray-200 hover:text-gray-900 focus:ring-2 focus:outline-none disabled:pointer-events-none'
        >
          <SiteIcon
